 ...
 */
public class ImportContent implements Serializable {
    ...
    public ImportContent() {
        ...
        this.relations = new ArrayList<ProjectRelation>();
     ...
     *
     */
    public ImportContent(final List<Project> projects, final List<Customer> customers, final List<User> users, final List<Campaign> campaigns, final List<Template> templates, final List<ProjectRelation> relations, final List<CampaignRelation> campaignRelations, final List<Preference> preferences) {
